...
const MODELS = {
  free: [
    // Groq (Ultra rapide - prioritaire)
    { id: 'qwen/qwen3.6-27b', name: 'Qwen 3.6 26B (Groq)', provider: 'groq', keyEnv: 'GROQ_API_KEY' },
    { id: 'qwen/qwen3.8-27b', name: 'Qwen 3.8 27B (Groq)', provider: 'groq', keyEnv: 'GROQ_API_KEY' },
    ...
    { id: 'groq/compound', name: 'Compound (Groq)', provider: 'groq', keyEnv: 'GROQ_API_KEY' },
    { id: 'groq/compound-mini', name: 'Compound Mini (Groq)', provider: 'groq', keyEnv: 'GROQ_API_KEY' },
    // OpenRouter Free (backup, plus lent)
